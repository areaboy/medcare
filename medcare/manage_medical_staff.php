...
<h3>Registered Doctors/Medical Staff in Pangea Users List</h3>
...
$('#loader_list_d').fadeIn(400).html('<br><div style="color:black;background:#ddd;padding:10px;"><img src="loader.gif" style="font-size:20px"> &nbsp;Please Wait,  Listing Registered Doctors/Medical Staff from Pangea Users List API.</div>');
var datasend = {d:d};
$.ajax({
			
			type:'POST',
			url:'./backend/list_users_doctors.php',
			data:datasend,
                        crossDomain: true,
			cache:false,
