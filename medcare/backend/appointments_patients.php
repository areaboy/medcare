...
session_start();
$pangea_userid_sess= strip_tags($_POST["pui"]);
...
<button id='statushide_$id' title='Click to Approve Appointments' class='report_css updates_btn'
 data-id='$id'
 data-userid='$id'
 >
...
data-diagnosis="'. strip_tags($row["diagnosis"]).'"
data-medication="'. strip_tags($row["medication"]).'"
>Write Patients <br>Medical  Diagnosis <br> OR Prescribe Drug & <br>Store in Pangea Vault </button>
