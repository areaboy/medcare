...
$result_verified = $db->prepare('select * from file_scan');
...
if($norows ==0){
echo "<div style='background:red;padding:8px;color:white;border:none;'>No Medical Files has been shared by any Patients Yet....</div>";
exit();
}


if($norows >0){
echo "<div style='background:green;padding:8px;color:white;border:none;'>List of Patients Shared Medical Files Scanned by Pangea File Intel.</div>";
