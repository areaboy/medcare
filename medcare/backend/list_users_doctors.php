...
echo "<div class='dangerx'>
 Listing Doctors/Medical Staff Count from Pangea Failed. Try Again.  Error: $summary  </div><br>";
exit();
...
if( $count ==0 ){
echo "<div class='dangerx'>&nbsp;&nbsp;&nbsp;&nbsp;No Doctors/Medical Staff Registered Yet on Pangea Users List </div><br>";
exit();
