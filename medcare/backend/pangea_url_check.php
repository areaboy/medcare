...
if($request_id !='' && $status == 'Success' ){
echo "<div class='successx'>Pangea URL Site Verification/Checking Successful</div><br>";
...
<br><b>Site Secured & Protected by Pangea Security</b>
...
echo "<div class='well'>
<h3  style='color:purple'>This Site Data is Unknown. However, You are Protected by Pangea Security ....</h3>
<b>Verified URL:</b> $url_check<br>
<b>Verification Score:</b> $score(%)<br>
<b>Verdict/Malicious Intent:</b> $verdict<br>
<b>Summary:</b> $summary<br>
