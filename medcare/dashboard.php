...
<button class="invite_btnx btn btn-warning"><a style="color:white;" href='file_scan.php' title='Share  Medical File'>Share  Medical File</a></button>

</li>

<li class="navgate">

<button class="invite_btnx btn btn-warning"><a style="color:white;" href='statistics.php' title='Appointments Statistics'>Statistics</a></button>
...
<h3>Users Pangea Medical Info</h3>
...
$('.loader_x').fadeIn(400).html('<br><div style="background:#ccc;color:black; width:100%;height:30%;text-align:center"><img src="ajax-loader.gif">&nbsp;Please Wait, Your Data is being Loaded</div>');
 ...
 var bck = $('#bc').DataTable({
  ...
  "order":[],
  "ajax":{
   url:"./backend/appointments_action.php",
   type:"POST",
