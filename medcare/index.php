...
<span style='color:red;font-size:10px;'> Additional protection of Your Data with Pangea Vault</span><br>
 ...
 <div class="form-group col-sm-12">
              <label> Enter Security Question</label>
              <input type="text" class="col-sm-12 form-control" id="questionp" name="questionp" placeholder="Enter Security Question" value=''>
            </div>


 <div class="form-group col-sm-12">
              <label> Enter Answer</label>
              <input type="text" class="col-sm-12 form-control" id="answerp" name="answerp" placeholder="Enter Answer" value='' >
            </div>
</div>
