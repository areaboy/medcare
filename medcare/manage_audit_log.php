...
<h3>Pangea Audit Log Monitoring System</h3>
...
$('#loader_list_d').fadeIn(400).html('<br><div style="color:black;background:#ddd;padding:10px;"><img src="loader.gif" style="font-size:20px"> &nbsp;Please Wait,  Loading Audit Log System.</div>');
var datasend = {d:d};
$.ajax({
			
			type:'POST',
			url:'./backend/list_audit_log.php',
			data:datasend,
                        crossDomain: true,
			cache:false,
